...
import { app } from '../index'; // We will export 'app' from index.js for testing
...
describe('Posts API Endpoints', () => {
  ...
  describe('GET /api/', () => {
    it('should return a list of posts', async () => {
      const mockPosts = [
        { id: '1', cardName: 'Blue-Eyes White Dragon', user: { displayName: 'Kaiba' } },
        { id: '2', cardName: 'Dark Magician', user: { displayName: 'Yugi' } },
      ];
